 ...
 <tr>
   <td> <input type="submit" value="إضافة" name="add" data-toggle="tooltip" data-placement="bottom" title="اضغط لاضافة حدث" class="btn btn-primary" center>
	...
	if(isset($_POST['add'])){
        ...
        $sql = mysql_query( "INSERT INTO event (name_Event ,description_Event,sartDate_Event,endDate_Event,location_Event,organization_name_Event,organizer_phone,maxNumOfAttendee,) VALUES('$eventName','$EventDescription','$sdaytime','$edaytime','$location','$organizationName','$Phone','$maxAttendee')")or die(mysql_error());
        if($sql!=null)
            echo "<div class='alert alert-success ' role='alert'>
             ...
             echo "<div class='alert alert-danger ' role='alert'> فشل يرجى التحقق من الادخال
					...
					echo "<div class='alert alert-danger ' role='alert'> ما دخل الايف
             </div>";
				}
