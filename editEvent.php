...
$organizationName = $_POST['organizationName'];
    ...
    $query = mysql_query( "UPDATE event SET name_Event='$eventName' ,description_Event='$EventDescription',sartDate_Event='$sdaytime',endDate_Event='$edaytime',location_Event='$location',organization_name_Event='$organizationName',organizer_phone='$Phone',maxNumOfAttendee='$maxAttendee'");


    if ($query)
		   echo "<script type='text/javascript'>alert('Updated successfully...!!')</script>";
	   else
		   echo "<script type='text/javascript'>alert('fill to Updated...!!')</script>";
...
<div>
  ...
  <div class="mainContent">
    ...
    <td class="rightTd">  <input type="text" id="fname" name="firstname" placeholder=" اسم الحدث " style=" width:400px" required ></td>
      <td class="leftTd">  <label for="fname">: اسم الحدث </label></td>
  </tr>
  <tr>
    <td>   <input type="text" id="lname" name="lastname" placeholder="اسم الشركة"  style=" width:400px" required></td>
