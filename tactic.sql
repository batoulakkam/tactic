...
CREATE TABLE `organizer` (
  ...
  `name-org` varchar(30) NOT NULL,
  `gender-org` varchar(6) NOT NULL,
  `DOB-org` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `organizer`
  MODIFY `organizer-id` int(11) NOT NULL AUTO_INCREMENT;
--
